<li class="nav-item <?php if(BaseClass::$oVariables->sCurrentUrl == $value['link']){ echo "active"; } ?>">
    <a class="nav-link" <?php if($value['dialog'] == true){echo "onClick=\"window.open('$value[link]', 'newwindow', 'width=300,height=250'); return falst;\"";} else {echo "href='$value[link]'";} ?>><?php echo $value['name']; ?>
